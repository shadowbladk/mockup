...
let ProductController = class ProductController {
    ...
    async createProduct(prodName, prodPass, prodAge) {
        const generatedId = await this.productService.create(prodName, prodPass, prodAge);
    ...
    async update(prodId, prodName, prodPass, prodAge) {
